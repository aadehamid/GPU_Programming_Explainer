# Exercise 5: dot product using reduction in shared memory[^1]

## Goal:

The purpose of this exercise is to implement dot product of two vectors on the GPU using reduction in shared memory.

## Instructions:

- move to subdierctory:
```console
$ cd 05-dot-product-reduction/
```
- load CUDA module:
```console
$ module load CUDA
